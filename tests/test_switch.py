...
from custom_components.integration_example import async_setup_entry
from custom_components.integration_example.const import DEFAULT_NAME, DOMAIN, SWITCH
...
async def test_switch_services(hass):
    ...
    with patch(
        "custom_components.vaillant-plus.IntegrationBlueprintApiClient.async_set_title"
    ) as title_func:
